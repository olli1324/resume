    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center">
        ...
        <div className="mt-6 flex justify-center space-x-4">
          ...
          <a href="mailto:oliver.hole.ekelund@hotmail.no" className="text-gray-600 hover:text-gray-900 transition-all duration-200 ease-in-out transform hover:scale-110" aria-label="Email">
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a href="https://www.linkedin.com/in/oliver-hole-ekelund" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-all duration-200 ease-in-out transform hover:scale-110" aria-label="LinkedIn">
